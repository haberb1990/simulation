...
public class Sim implements Comparable<Sim>
{
    ...
    public int compareBirth(Sim o) 
    {
        return Double.compare(o.birthtime,this.birthtime);
    }
    ...
    {
        return getIdentString(this)+" ["+birthtime+".."+deathtime+", mate "
    +getIdentString(mate)+"\tmom "+getIdentString(getMother())+"\tdad "+getIdentString(getFather())
        +"]";
    }
}