...
public class AgeModel 
{
    ...
    private static final double FIDELITY = 0.9; // paramètre de fidélité 
    ...
    public static double getFidelity() {
  		return FIDELITY;
  	}
    ...
    /**
     * A random value for the sex.
     * 
     * @param RND Psudorandom number generator for uniform[0,1]
     * 
     * @return Male or Female
     */
    public Sim.Sex randomSex(Random RND) {
        int randID = RND.nextInt(2);
        return Sim.Sex.values()[randID];
    }
